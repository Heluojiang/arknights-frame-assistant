...
<br>
这是一个用于优化明日方舟目前PC端体验的小工具，提供包括但不限于全按键自定义、过帧等功能
</div>
...
本程序的按键功能仅在明日方舟进程生效，不会影响游戏以外的操作

### 4. 支持随游戏进程关闭自动退出

本程序支持随明日方舟进程的关闭自动退出
<br>
本程序基于AutoHotkey开发，由于大部分MMORPG或者竞技类网游的反作弊系统对使用AutoHotKey开发的程序非常敏感
<br>
很可能将本程序当做作弊程序或非法程序处理，导致游戏无法正常启动，甚至导致使用者的账号遭受封禁
<br>
因此强烈建议开启小助手的“随游戏进程关闭自动退出”功能，避免因忘关工具触发反作弊
<br>

## 注意事项

### 游戏内的按键设置需为默认设置，如果你不记得了，请按照以下说明修改：
...
如果你的屏幕刷新率大于等于120赫兹，那么可以开启垂直同步，且小助手内的“游戏内帧数”可以设置成120
<br>
如果你的屏幕刷新率低于120赫兹，那么不要开启垂直同步，且确保小助手内的“游戏内帧数”设置与游戏里设置的帧数一致
